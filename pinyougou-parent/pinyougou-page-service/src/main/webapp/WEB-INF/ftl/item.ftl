                        ...
                        <#list specificationItems as specification>
                            ...
                            <#--  selected  -->
                                <#list specification.attributeValue as attribute>
                                    <dd><a href="javascript:;" class="{{isSelected('${specification.attributeName}','${attribute}')?'selected':''}}" ng-click="selectSpecificationItems('${specification.attributeName}','${attribute}')">${attribute}<span title="点击取消选择">&nbsp;</span></a></dd>
                                </#list>
                            </dl>
